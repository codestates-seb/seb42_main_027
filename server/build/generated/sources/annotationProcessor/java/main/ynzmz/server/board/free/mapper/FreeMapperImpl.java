...
public class FreeMapperImpl implements FreeMapper {
    ...
    protected FreeCommentDto.ResponseForFreeDetail freeCommentToResponseForFreeDetail(FreeComment freeComment) {
        ...
        FreeCommentDto.ResponseForFreeDetail responseForFreeDetail = new FreeCommentDto.ResponseForFreeDetail( freeCommentId, content, createdAt, modifiedAt, voteCount, member, memberSim );
