package ynzmz.server.vote.qna.answer.controller;
...
import ynzmz.server.vote.qna.answer.mapper.AnswerVoteMapper;
import ynzmz.server.vote.qna.answer.service.AnswerVoteService;

@RestController
@RequestMapping("votes/qnas/answers")
