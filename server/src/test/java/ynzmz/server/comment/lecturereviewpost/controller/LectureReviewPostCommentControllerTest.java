...
class LectureReviewPostCommentControllerTest {
    ...
    void createLectureReviewPostComment() throws Exception {
        ...
        when(lectureReviewPostCommentMapper.lectureReviewPostCommentToLectureReviewPostCommentPost(any())).thenReturn(new LectureReviewPostComment());
    ...
    void updateLectureReviewPostComment() throws Exception {
        LectureReviewPostCommentDto.Patch mockPatch = new LectureReviewPostCommentDto.Patch("이사람 재대로 들은거 맞음?",
                "2023.03.10.18:52:36");
        String jsonPatch = gson.toJson(mockPatch);
        long lectureReviewPostCommentId = 1L;

        when(lectureReviewPostCommentMapper.lectureReviewPostCommentToLectureReviewPostCommentPatch(any())).thenReturn(new LectureReviewPostComment());
        when(lectureReviewPostCommentMapper.lectureReviewPostCommentResponseToLectureReviewPostComment(any())).thenReturn(lectureReviewPostCommentResponse);
    ...
    void getLectureReviewPostComments() throws Exception {
        ...
        when(lectureReviewPostCommentService.getLectureReviewPostComments(anyLong(),anyString(),anyInt(),anyInt())).thenReturn(new PageImpl<>(new ArrayList<>(List.of(new LectureReviewPostComment())), PageRequest.of(1,1),1));
        when(lectureReviewPostCommentMapper.lectureReviewPostCommentResponsesToLectureReviewPostComments(any())).thenReturn(lectureReviewPostCommentResponses);
