...
@WebMvcTest(controllers = LectureReviewPostCommentVoteController.class)
@AutoConfigureRestDocs
@MockBean(JpaMetamodelMappingContext.class)
class LectureReviewPostCommentVoteControllerTest {
    @Autowired
    private MockMvc mockMvc;
    @Autowired
    private Gson gson;
    @MockBean
    private LectureReviewPostCommentVoteService lectureReviewPostCommentVoteService;
    @MockBean
    private LectureReviewPostCommentService lectureReviewPostCommentService;
    @MockBean
    private LectureReviewPostCommentVoteMapper lectureReviewPostCommentVoteMapper;
    @MockBean
    ...
    void questionVoteUpPost() throws Exception {
        ...
        when(lectureReviewPostCommentService.findLectureReviewPostCommentById(anyLong())).thenReturn(new LectureReviewPostComment());
        when(memberService.findMemberById(anyLong())).thenReturn(member);
        when(lectureReviewPostCommentVoteService.lectureReviewPostVoteUp(any(),any())).thenReturn(lectureReviewPostCommentVote);
        when(lectureReviewPostCommentVoteMapper.lectureReviewPostVoteToLectureReviewPostResponse(any(),any())).thenReturn(lectureReviewPostCommentVoteResponse);
    ...
    void questionVoteDownPost() throws Exception {
        ...
        when(lectureReviewPostCommentService.findLectureReviewPostCommentById(anyLong())).thenReturn(new LectureReviewPostComment());
        when(memberService.findMemberById(anyLong())).thenReturn(member);
        when(lectureReviewPostCommentVoteService.lectureReviewPostVoteDown(any(),any())).thenReturn(lectureReviewPostCommentVote);
        when(lectureReviewPostCommentVoteMapper.lectureReviewPostVoteToLectureReviewPostResponse(any(),any())).thenReturn(lectureReviewPostCommentVoteResponse);
