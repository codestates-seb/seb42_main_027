...
class LectureReviewPostControllerTest {
    ...
    void postReviewPost() throws Exception {
        ...
        when(lectureReviewPostService.getLectureReviewPostAverageStarPoint(any())).thenReturn(4.5);
        when(lectureReviewPostService.createLectureReviewPost(any())).thenReturn(lectureReviewPost);
        when(lectureReviewPostMapper.lectureReviewPostInfoResponseToLectureReviewPost(any())).thenReturn(lectureReviewPostInfoResponse);
    ...
    void patchReviewPost() throws Exception {
        ...
        LectureReviewPostDto.Patch mockPatch = new LectureReviewPostDto.Patch("이 강의 추천합니다!",
                4.5,
                "꼼꼼하게 설명해주시는게 좋네요",
                "2023.03.10.18:52:36");
        ...
        when(lectureReviewPostMapper.lectureReviewPostToLectureReviewPostPatch(any())).thenReturn(new LectureReviewPost());
        when(lectureReviewPostService.updateLectureReviewPost(any())).thenReturn(lectureReviewPost);
        when(lectureReviewPostService.getLectureReviewPostAverageStarPoint(any())).thenReturn(4.5);
        when(lectureReviewPostMapper.lectureReviewPostInfoResponseToLectureReviewPost(any())).thenReturn(lectureReviewPostInfoResponse);
    ...
    void getLectureReviewPostsByTeacher() throws Exception {
        ...
        when(lectureReviewPostService.findLectureReviewPostsByLecture(anyLong(),anyInt(),anyInt())).thenReturn(new PageImpl<>(new ArrayList<>(List.of(new LectureReviewPost())), PageRequest.of(1,1),1));
        when(lectureReviewPostService.findLectureReviewPostsByTeacher(anyLong(),anyInt(),anyInt())).thenReturn(new PageImpl<>(new ArrayList<>(List.of(new LectureReviewPost())), PageRequest.of(1,1),1));
        when(lectureReviewPostMapper.lectureReviewPostInfoResponsesToLectureReviewPosts(any())).thenReturn(lectureReviewPostInfoResponses);
    ...
    void getReviewPostDetail() throws Exception {
        ...
        when(lectureReviewPostService.findLectureReviewPostById(anyInt())).thenReturn(new LectureReviewPost());
        when(lectureReviewPostMapper.lectureReviewPostInfoResponseToLectureReviewPost(any())).thenReturn(lectureReviewPostInfoResponse);
